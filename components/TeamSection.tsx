...
const TEAM_MEMBERS = [
  {
    ...
    bio: 'Industrial Engineer with previous experience in managing the Israeli Railway System and managing product development of other tech companies including Judea. Ariel brings his vast experience and knowledge into his Chief Operations Officer (COO) role at ChainGPT.'
  },
  {
    name: 'Vlad Filatov',
...
const TeamSection: React.FC = () => {
  ...
  return (
    <section className="w-full bg-[#111111] border-b border-white/10 relative">
      {/* Header Row */}
      <div className="flex flex-col md:flex-row md:h-48 border-b border-white/10">
        {/* Title Area */}
        <div className="w-full md:w-1/2 flex items-center px-6 md:px-12 py-12 md:py-0 border-b md:border-b-0 md:border-r border-white/10 bg-white/5">
        ...
        {/* Tagline Area */}
        <div className="w-full md:w-1/4 p-8 md:p-10 flex items-start gap-3 border-b md:border-b-0 md:border-r border-white/10">
        ...
        {/* Carousel Nav Area */}
        <div className="flex-1 flex items-center md:items-end justify-center md:justify-end p-6 md:p-8">
      ...
      <div className="flex flex-col sm:grid sm:grid-cols-2 lg:flex lg:flex-row w-full min-h-[500px]">
        {TEAM_MEMBERS.map((member, index) => (
          <div 
            key={member.name} 
            className={`w-full lg:w-1/4 p-6 md:p-8 flex flex-col gap-6 items-center border-b lg:border-b-0 ${index !== TEAM_MEMBERS.length - 1 ? 'lg:border-r border-white/10' : ''}`}
          ...
          >
            ...
            >
              {/* Front Side */}
              <div 
                className="w-full bg-black p-0 flex flex-col border border-white/10 shadow-sm relative group cursor-pointer hover:shadow-xl transition-shadow"
              ...
              >
                 ...
                 <div className="relative p-4 flex items-center justify-center bg-black group-hover:bg-gray-900 transition-colors">
                    ...
                    <button 
                      ...
                      className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.2em] mono-font text-white"
                    >
              ...
              >
                ...
                {/* Main Content Area */}
                <div className="flex-1 p-10 pt-14 flex flex-col border-b border-black/10">
