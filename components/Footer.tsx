      ...
      <div className="flex flex-col md:flex-row w-full border-b border-white/10 relative">
        ...
        <div className="w-full md:w-1/4 p-8 md:p-12 border-b md:border-b-0 md:border-r border-white/10 relative">
          ...
          <ul className="space-y-4">
            ...
            <li><Link to="/beta" className="text-sm font-medium mono-font text-white hover:text-[#35CB87] transition-colors">LAUNCH APP</Link></li>
        ...
        <div className="w-full md:w-1/4 p-8 md:p-12 border-b md:border-b-0 md:border-r border-white/10 relative">
          ...
          <ul className="space-y-4">
            <li><Link to="/privacy" className="text-sm font-medium mono-font text-white hover:text-[#35CB87] transition-colors">Privacy Policy</Link></li>
            <li><Link to="/cookies" className="text-sm font-medium mono-font text-white hover:text-[#35CB87] transition-colors">Cookie Policy</Link></li>
            <li><Link to="/terms" className="text-sm font-medium mono-font text-white hover:text-[#35CB87] transition-colors">Terms of Service</Link></li>
          </ul>
        </div>
